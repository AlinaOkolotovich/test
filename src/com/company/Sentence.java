...
public class Sentence extends Word {
    ...
    private char enterNewValue() {
        ...
        if (enteredValue.length() != 1 || enteredValue.contains(" ")) {
            System.out.println("OOPS, new value should consist of 1 digit and should have no spaces. Please enter correct value.");
            enterNewValue();
        } else {
